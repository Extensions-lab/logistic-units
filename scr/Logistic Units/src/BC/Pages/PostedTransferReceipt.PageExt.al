pageextension 71628588 "TMAC Posted Transfer Receipt" extends "Posted Transfer Receipt"
{
    layout
    {
    ...
    begin
        SourceType := Database::"Transfer Receipt Line";
        SourceSubtype := 0;
        SourceID := Rec."No.";
    end;
    ...
    begin
        ...
        CurrPage.TransferReceiptLines.Page.GetSelectedLineLinks(SourceDocumentLink);
    end;
