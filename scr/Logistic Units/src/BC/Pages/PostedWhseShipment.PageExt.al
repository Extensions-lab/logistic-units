pageextension 71628582 "TMAC Posted Whse. Shipment" extends "Posted Whse. Shipment"
{
    layout
    {
    ...
    actions
    {
        addafter(Category_Process)
        {
            ...
            {
                Caption = 'Logistic Units';
                ToolTip = 'Warehouse Management System function';
    ...
    begin
        SourceType := Database::"Posted Whse. Shipment Line";
        SourceSubtype := 0;
        SourceID := Rec."No.";
    end;
