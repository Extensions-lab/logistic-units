pageextension 71628586 "TMAC Posted Purchase Receipt" extends "Posted Purchase Receipt"
{
    layout
    {
    ...
    begin
        SourceType := Database::"Purch. Rcpt. Line";
        SourceSubtype := 0;
        SourceID := Rec."No.";
    end;
    ...
    begin
        ...
        CurrPage.PurchReceiptLines.Page.GetSelectedLineLinks(SourceDocumentLink);
    end;
