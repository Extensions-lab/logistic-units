pageextension 71628585 "TMAC Posted Return Receipt" extends "Posted Return Receipt"
{
    layout
    {
    ...
    begin
        SourceType := Database::"Return Receipt Line";
        SourceSubtype := 0;
        SourceID := Rec."No.";
    end;
    ...
    begin
        ...
        CurrPage.ReturnRcptLines.Page.GetSelectedLineLinks(SourceDocumentLink);
    end;
