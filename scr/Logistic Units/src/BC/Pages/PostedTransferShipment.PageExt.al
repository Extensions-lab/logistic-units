pageextension 71628589 "TMAC Posted Transfer Shipment" extends "Posted Transfer Shipment"
{
    layout
    {
    ...
    begin
        SourceType := Database::"Transfer Shipment Line";
        SourceSubtype := 0;
        SourceID := Rec."No.";
    end;
    ...
    begin
        ...
        CurrPage.TransferShipmentLines.Page.GetSelectedLineLinks(SourceDocumentLink);
    end;
