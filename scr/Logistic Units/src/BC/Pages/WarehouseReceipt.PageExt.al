pageextension 71628579 "TMAC Warehouse Receipt" extends "Warehouse Receipt"
{
    layout
    {
    ...
    actions
    {
        ...
        addafter("Post Receipt_Promoted")
        {
        ...
        addbefore("F&unctions")
        {
            ...
            {
                Caption = 'Logistic Units';
                ToolTip = 'Operations with logistic units';
        ...
        addafter("Post Receipt")
        {
            action("TMAC Post Logistic Unit")
            {
                ...
                Image = PostOrder;
                Enabled = IsLogiticUnits;
                ToolTip = 'Post the logistic unit as received. Related receipt documents are registered automatically.';
                AccessByPermission = tabledata "TMAC Unit" = I;
                ...
                begin
                    UnitPost.Post(SourceType, SourceSubtype, SourceID, Database::"Posted Whse. Receipt Line", true);
                end;
            }
        }
    }
    ...
    begin
        SourceType := Database::"Warehouse Receipt Line";
        SourceSubtype := 0;
        SourceID := Rec."No.";
    end;
    ...
    begin
        ...
        CurrPage.WhseReceiptLines.Page.GetSelectedLineLinks(SourceDocumentLink);
    end;
