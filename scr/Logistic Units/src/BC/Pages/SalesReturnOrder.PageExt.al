pageextension 71628580 "TMAC Sales Return Order" extends "Sales Return Order"
{
    layout
    {
        addbefore(Control1900316107)
        {
    ...
    actions
    {
        ...
        addafter(Post)
        {
            action("TMAC Post Logistic Unit")
            {
                ...
                begin
                    UnitPost.Post(SourceType, SourceSubtype, SourceID, Database::"Return Receipt Line", true);
                end;
            }
        }
    }
