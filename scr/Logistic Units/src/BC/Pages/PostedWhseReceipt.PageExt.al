pageextension 71628583 "TMAC Posted Whse. Receipt" extends "Posted Whse. Receipt"
{
    layout
    {
        addbefore(Control1905767507)
        {
            part("TMAC Logistic Units Subform"; "TMAC Unit List FactBox")
            {
    ...
    begin
        NoOfLogisticUnit := CurrPage."TMAC Logistic Units Subform".PAGE.SetSource(SourceType, SourceSubtype, SourceID, 'Inbound', 'Outbound');
    ...
    begin
        ...
        CurrPage.PostedWhseRcptLines.Page.GetSelectedLineLinks(SourceDocumentLink);
    end;
