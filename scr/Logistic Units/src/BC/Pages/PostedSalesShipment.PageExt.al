pageextension 71628584 "TMAC Posted Sales Shipment" extends "Posted Sales Shipment"
{
    layout
    {
    ...
    begin
        SourceType := Database::"Sales Shipment Line";
        SourceSubtype := 0;
        SourceID := Rec."No.";
    end;
    ...
    begin
        ...
        CurrPage.SalesShipmLines.Page.GetSelectedLineLinks(SourceDocumentLink);
    end;
